...
const matrix_traversal_1 = require("./matrix-traversal");
...
async function runTest() {
    try {
        const result = await (0, matrix_traversal_1.getMatrix)(SOURCE_URL);
        console.log("Result:", result);
        const testPassed = JSON.stringify(result) === JSON.stringify(EXPECTED_TRAVERSAL);
